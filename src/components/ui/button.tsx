  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow transform hover:scale-105 shadow-medium",
        emergency: "bg-gradient-emergency text-white hover:shadow-strong transform hover:scale-105 animate-pulse-glow",
        warning: "bg-gradient-warning text-warning-foreground hover:shadow-strong transform hover:scale-105",
        success: "bg-primary text-primary-foreground hover:bg-primary-glow shadow-soft hover:shadow-glow transform hover:scale-105",
      },
      size: {
